...
public static b4a.example.finger _finger = null;
  public Object[] GetGlobals() {
		return new Object[] {"act_tip",Debug.moduleToString(b4a.example.act_tip.class),"C",Debug.moduleToString(b4a.example.c.class),"finger",Debug.moduleToString(b4a.example.finger.class),"Home",Debug.moduleToString(b4a.example.home.class),"login",Debug.moduleToString(b4a.example.login.class),"Main",Debug.moduleToString(b4a.example.main.class),"page",Debug.moduleToString(b4a.example.page.class),"Service",starter.mostCurrent._service,"verify",Debug.moduleToString(b4a.example.verify.class)};
}
}